                  ...
                  <Form>
                    ...
                    <div className="flex items-center">
                      <button
                        ...
                        className="text-gray-700 bg-white hover:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-primary-500 h-8 w-8 inline-flex items-center justify-center"
                      >
                        &ndash;
                      </button>
                      <span className="mx-2 text-base leading-5 font-medium text-gray-700">
                        {line.quantity}
                      </span>
                      <button
                        type="button"
